...
public class FutureWorkDAOImpl implements FutureWorkDAO {
    ...
    public List<FutureWork> getUpcomingJobsByWorker(int workerId) throws SQLException {
        ...
        String sql = "SELECT aw.task_id, wr.title, aw.worker_id, wr.preferred_work_date, aw.status, aw.household_rating, aw.address FROM workrequests wr LEFT JOIN assignedtasks aw ON wr.request_id = aw.request_id WHERE aw.worker_id = ?;";
